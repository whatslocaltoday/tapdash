          ...
          return false;
            ...
            public function new_permission_add() { 
                ...
                if ($result == TRUE) {
                        ...
                        "message_display"=>"Added Successfully!"
...

            {
...

                {
                    ...
                    $config = array(
                        ...
                        'base_url' => base_url('admin/Setting/list_permission'),
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $data=array(
                    ...
                    $data1 = array(
                        ...
                        "name"=>$this->input->post('cuntry_name'),

                        "phonecode"=>$this->input->post('cuntry_phcode')
...

            {
...

                {
                    ...
                    $config = array(
                        ...
                        'base_url' => base_url('admin/Setting/list_country'),
             ...
             if ($ch_permsn=='0' || $countery_id === NULL)
             {
                ...
                foreach($result as $row)
                {
                    $data=array(
                        ...
                        "cuntry_name"=>$row->name,

                        "cuntry_phcode"=>$row->phonecode,
...

{
    ...
    $config = array(
        ...
        'base_url' => base_url('admin/Setting/list_currency'),
