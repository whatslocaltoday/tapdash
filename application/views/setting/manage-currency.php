                  ...
                  <div class="x_content">
                        ...
                        <thead>
                          <tr class="headings">                           
                            ...
                            <th width="30%" class="column-title">Country Name </th>
														<th width="30%" class="column-title">Currency Symbol </th>   
                        ...
                        <tbody>
                        	...
                        	foreach($results as $row) {
													...
													<tr class=\"gradeU\">
													".form_open('admin/Setting/view_edit_currency')."
															<td hidden > <input type=\"text\" id=\"currency_id\" name=\"currency_id\" value='".$row->id."' ></td>
															<td align=\"center\">".$sl++."</td>
															<td>".$row->code."</td>
															<td>".$row->counutry_name."</td>
															<td>".$row->symbol."</td>
															<td align='center'>
