        ...
        <div class="right_col clearfix" role="main">
			<div class="page-title">
				...
				<div class="title_left col-md-6">
					<h3>Upload Bulk Facebook Adwords Data</h3>
				</div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="background: none">
							...
							<div class="well clearfix">								
								<div class="col-md-8"><?php echo  form_open_multipart(base_url().'admin/Process/fb_csv_adword_import')?>
                            ...
                            <div class="inventory-setting-csv">
                                <h3 style="padding-top: 10px;">Upload Facebook Adwords in CSV Format</h3>
                                <p>This page explains how to upload your Facebook Adwords data using a CSV file </p>
...
<!-- /end Flash Data -->
                   <button type="button" class="btn btn-info btn-lg csv-standard" data-toggle="modal" data-target="#csv_mobile">Import csv Facebook Adwords Plan Progress</button>
					</div>
				  </div>
