        ...
        <div class="right_col clearfix" role="main">
            ...
            <li style="padding-left: 70%;"><a href="<?php base_url(); ?>disconnect-analytics/"><i class="fa fa-times"></i> Disconnect Google Analytics</a></li>
        ...
        <div class="col-md-6">
         ...
         <div class="col-md-12 col-sm-12 col-xs-12">
          ...
          <div id="sessioncontainer" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
...
<?php if(!empty($resultError)) {
  ...
  die;
      ...
      <!-- <li><a href="tel:+919810264027" class="gadsclickcalltrackuk"><i class="fa fa-phone mr-1 "></i><span> : +919810264027</span></a></li> -->
    ...
    <?php
          if(!empty($organicSession['nonorganic']))
          {
            // foreach ($organicSession['nonorganic'] as $account) {
...
//    print_r($organicSession['nonorganic']);
//    die;


if(!empty($organicSession['organic']))
{
  // for ($j=5; $j >=0; $j--)
  // {
  //   echo $organicSession['organic'][$j].',';
  // }
}
    ?>
    ...
    series: [{
        ...
        data: [
          ...
          if(!empty($organicSession['nonorganic']))
          {
            for ($j=5; $j >=0; $j--)
            {
              echo $organicSession['nonorganic'][$j].',';
            }
          }
...
Highcharts.chart('sessioncontainer', {
...
<script src="<?php echo base_url()?>admin-assets/build/js/analytics_tp.js"></script>