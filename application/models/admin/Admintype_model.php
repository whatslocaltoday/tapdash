...
Class Admintype_model extends CI_Model {
...

    {
        ...
        $insdataacluser=array(
            ...
            'user_role_id'=>$data['user_type'],

            'acl'=>$data['permsn_name']
...
//add new webiste 
...

    {
        ...
        $insdatauser=array(
            ...
            'google_a_id'=>$data['google_a_id'],

            'face_analytic_id'=>$data['face_analytic_id'],
