...
class CreateAccount_model {
    ...
    public function main()
    {
        ...
        $new_account = new CreateAccount_model;  
        $acc_name="test for name";
        $new_account->runExample($acc_name,new AdWordsServices(), $session);
    }
}

CreateAccount_model::main();
